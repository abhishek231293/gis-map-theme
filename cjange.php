...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper">
        ...
        <!-- #Sidebar Form -->
        <div id="firstView" class="sidebar-landing">
            <!-- Sidebar Main Panel -->
            ...
            <div class="sidebar-position">
                <div class="sidebar-position-border" data-toggle="tooltip" title="Central">
                    <div class="sidebar-position-action-icon">
                        ...
                        <a onclick="setMapCenter(24.708317,46.687050)">
                            <img src="<?php echo $this->getUrl();?>public/mapv1/assets/images/map.png" width="120" height="120">
                        </a>
                    </div>
        ...
        <div class="sidebar-network" id="secondView" style="display: none;">
            <!-- Sidebar Image -->
            <div id="atmImage" class="sidebar-refer-panel">
                <img src="<?php echo $this->getUrl();?>public/mapv1/assets/images/street.JPG" class="sidebar-refer-image"/>
            </div>
            <!-- #Sidebar Image -->
            ...
            <div class="sidebar-carousel">
                <div  id="showcase" class="noselect">
                    <img src="<?php echo $this->getUrl();?>public/mapv1/assets/images/1.jpg" class="cloud9-item", alt="Item #1"/>
                    <img src="<?php echo $this->getUrl();?>public/mapv1/assets/images/1.jpg" class="cloud9-item", alt="Item #2"/>
                    <img src="<?php echo $this->getUrl();?>public/mapv1/assets/images/1.jpg" class="cloud9-item", alt="Item #3"/>
                    <img src="<?php echo $this->getUrl();?>public/mapv1/assets/images/1.jpg" class="cloud9-item", alt="Item #4"/>
                </div>
                <footer>
            ...
            <div class="col-lg-12">
                <div style="width:100vw; height:100vh;">
                    <div id="map-container" style="width:100%;height:100%">
                        <div style="color: black; position: absolute; top: 45%; left: 50%">
                            <img style="width: 15%; height: 15%;" src="<?php echo $this->getUrl()?>/public/img/ajax-loaders/map-loader1.gif">
                        </div>
                    </div>
                </div>
            </div>
